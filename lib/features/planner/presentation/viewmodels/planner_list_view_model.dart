...
class PlannerListViewModel extends _$PlannerListViewModel {
  ...
  Future<void> getPlanners() async {
    ...
    try {
      GetPlannersUseCase getPlannersUseCase = ref.read(getPlannersUseCaseProvider);
  ...
  Future<void> deletePlanner(String plannerId) async {
    ...
    try {
      DeletePlannerUseCase deletePlannerUseCase = ref.read(deletePlannerUseCaseProvider);
